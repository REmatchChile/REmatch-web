  ...
  return (
    (index === 1 && activeStep === 1 && (
      <div>
        <Typography
          variant='caption'
          color={activeSubStep === 0 ? "secondary" : "disabled"}>
          Problem
        </Typography>
        <br />
        <Typography
          variant='caption'
          color={activeSubStep === 1 ? "secondary" : "disabled"}>
          An efficient solution
        </Typography>
        <br />
        <Typography
          variant='caption'
          color={activeSubStep === 2 ? "secondary" : "disabled"}>
          Last step
        </Typography>
      </div>
    )) ||
    (index === 2 && activeStep === 2 && (
      <div>
        <Typography variant='caption' onClick={() => console.log("a")}>
          Larvita
        </Typography>
      </div>
    ))
